...
function TatLogicPage() {
  ...
  // No role and not Admin = no legitimate use for this screen — purely
  // static content, but access should still be consistent app-wide.
    ...
    <AppShell>
      ...
      <PageBody>
        <Card>
          ...
          <CardContent className="space-y-2 text-sm">
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>
                <b>Start status</b> and <b>End status</b> — two workflow milestones.
              </li>
              <li>
                <b>TAT per CR Size</b> — Small / Medium / Large targets (in working days).
              </li>
              <li>
                <b>Warning %</b> — share of TAT after which status turns Amber.
              </li>
              <li>
                <b>Excluded statuses</b> — workflow states that pause the timer for this KPI.
              </li>
            </ul>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-2 text-sm">
            <p>
              Every populated workflow timestamp on the CR row is collected into one chronological
              list. This is the single source of truth for all KPIs on that CR.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-2 text-sm">
            <ul className="list-disc pl-5 space-y-1">
              <li>
                <b>Start date</b> = earliest entry matching the KPI's start status.
              </li>
              <li>
                <b>End date</b> = first entry <i>after</i> start matching the end status.
              </li>
              <li>
                If end has not occurred yet, the KPI is <b>in progress</b> and the current time is
                used as a running end.
              </li>
              <li>
                If start has not occurred yet, status = <b>Not Started</b>.
              </li>
              <li>
                If start exists but CR Size is blank, status = <b>Pending</b> (no TAT to compare
                against).
              </li>
            </ul>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent className="space-y-2 text-sm">
            <p>
              Calendar time between two timestamps is walked one day at a time. Hours that fall on{" "}
              <b>Saturday or Sunday are dropped</b> from both elapsed and hold totals. Public
              holidays are <i>not</i> currently excluded.
            </p>
        ...
        <Card>
          ...
          <CardContent className="space-y-2 text-sm">
            <p>
              The timeline is walked segment by segment from start to end. A segment is the interval
              the CR spent inside one status. If that status is in the KPI's{" "}
              <b>Excluded Statuses</b>, the segment's weekday duration is added to <b>hold_days</b>.
            </p>
        ...
        <Card>
          ...
          <CardContent className="space-y-2 text-sm">
            <p className="font-mono bg-muted p-2 rounded text-xs">
              effective_days = max(0, total_days − hold_days)
              <br />
              tat = TAT for the CR's size (Small | Medium | Large)
              <br />
              remaining_days = tat − effective_days
              <br />
        ...
        <Card>
          ...
          <CardContent className="space-y-2 text-sm">
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>
                On demand via the <b>Recalculate KPIs</b> button.
              </li>
            </ul>
            <p className="text-muted-foreground">
              All results are written to one table (<span className="font-mono">kpi_results</span>)
              and every dashboard / worklist reads from there — there is no second copy of the math
              anywhere.
            </p>
          </CardContent>
        </Card>
